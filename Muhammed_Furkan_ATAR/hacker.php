...
<!-- Type  http://www.angelfire.com/nm/wimmer1/password.html to get there -->
...
function faketake(percent1){
 if(percent1 < 100){
   ...
   window.status="MERAK ETME ŞAKA BU: "+percent1+"% complete";
...
alert("EMAIL hack@atar.info.com to figure out how to get rid of it");
